About eventlet-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/eventlet-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=275&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/eventlet-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `eventlet` can be installed with `conda`:
...
```
mamba install eventlet
```

It is possible to list all of the versions of `eventlet` available on your platform with `conda`:
...
```
mamba search eventlet --channel conda-forge
```
...
mamba repoquery search eventlet --channel conda-forge

# List packages depending on `eventlet`:
mamba repoquery whoneeds eventlet --channel conda-forge

# List dependencies of `eventlet`:
mamba repoquery depends eventlet --channel conda-forge
```
